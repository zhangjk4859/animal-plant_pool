...
class JKAlertView: UIView {
    ...
    class func showMessage(_ message: String, duration time: TimeInterval) {
        ...
        var attributes: [AnyHashable: Any] = [NSFontAttributeName: UIFont.systemFont(ofSize: CGFloat(15.0)), NSParagraphStyleAttributeName: paragraphStyle]
        var labelSize = message.boundingRect(with: CGSize(width: CGFloat(207), height: CGFloat(999)), options: .usesLineFragmentOrigin, attributes: attributes, context: nil).size
